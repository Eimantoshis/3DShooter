...
public class BasicSpawner : MonoBehaviour, INetworkRunnerCallbacks
{
  ...
  public void OnPlayerJoined(NetworkRunner runner, PlayerRef player)
  {
    if (runner.IsServer)
    {
      ...
      PlayerMovement movement = networkPlayerObject.GetComponent<PlayerMovement>();
    }
  }
  ...
  public void OnInput(NetworkRunner runner, NetworkInput input)
  {
    ...
    if (_spawnedCharacters.TryGetValue(runner.LocalPlayer, out NetworkObject networkObject))
    {
      ...
      {
        data.direction = playerMovement.GetMovementDirection();
        data.jumpPressed = jumpQueued;
            
        // Reset the jump queue after it's been sent
        jumpQueued = false;
      }
    }
